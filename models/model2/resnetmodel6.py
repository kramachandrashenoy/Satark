...
def recognize():
    ...
    model_path = r"C:\Users\Ramachandra\Downloads\distracted-02-0.98.hdf5" # Replace with your actual model path
    ...
    while True:
        ...
        # Preprocess the frame for your model (resize to 64x64)
        ...
        if not eyes_detected:
            if eyes_closed_start_time is None:
                ...
                alarm_sound(r"C:\Users\Ramachandra\OneDrive\Desktop\driver Model 1\alarm.mp3")  # Replace with your alarm sound path
